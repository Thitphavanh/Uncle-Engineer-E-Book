...
usermod -aG sudo uncleebook

# คัดลอก SSH keys
rsync --archive --chown=uncleebook:uncleebook ~/.ssh /home/uncleebook
```
...
# เข้าใหม่ด้วย uncleebook user
ssh uncleebook@YOUR_SERVER_IP
```
...
**เนื้อหา:**
```
/home/uncleebook/apps/uncleebook/logs/*.log {
    daily
    missingok
    rotate 14
    compress
    delaycompress
    notifempty
    create 0640 uncleebook uncleebook
    sharedscripts
}
```
...
# Variables
BACKUP_DIR="/home/uncleebook/backups"
PROJECT_DIR="/home/uncleebook/apps/uncleebook"
...
```cron
0 2 * * * /home/uncleebook/backup.sh >> /home/uncleebook/backup.log 2>&1
```
